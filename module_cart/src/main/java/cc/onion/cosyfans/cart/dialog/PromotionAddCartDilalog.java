 ...
 *
 */
public class PromotionAddCartDilalog extends BaseBottomSheetDialog implements AddItemArraryAdapter.ChooseCurrentItem {
    ...
    AddCartStateListener addCartStateListener;

    public PromotionAddCartDilalog(ItemDetailRequest request, @NonNull Context context, AddCartStateListener addCartStateListener) {
        super(context);
        this.mContext = context;
        this.request = request;
        this.addCartStateListener = addCartStateListener;
                ...
                .subscribe(new ResponseObserver<BaseResponse>() {
                    ...
                    public void onSuccess(BaseResponse data) {
                        if(data.getStatus().equals("200")){
                            //刷新操作
                            addCartStateListener.onSuccess();
                    ...
                    public void onError(String code, String msg) {
                        addCartStateListener.onError();
                        ToastUtil.Short(msg);
                        EventBus.getDefault().post(AddStateEvent.SIGNIN_ERROR);
                        dismiss();
