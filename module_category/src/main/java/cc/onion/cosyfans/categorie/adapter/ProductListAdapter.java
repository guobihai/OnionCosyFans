 ...
 * 部门标签适配器
 */
public class ProductListAdapter extends BaseQuickAdapter<CategorieListEntity.DataBean, BaseViewHolder> {

    private Context mContext;
    private List<CategorieListEntity.DataBean> leftListArray = null;
    private int currentPosition = 0;

    public ProductListAdapter(@Nullable List<CategorieListEntity.DataBean> data, Context activity) {
        super(R.layout.categorie_list_item_products, data);
    ...
    protected void convert(BaseViewHolder helper, CategorieListEntity.DataBean item) {
        ...
        try {
            ...
            BaseBindingAdapter.loadImageFitCenterType(imageView,item.getImageMedium());
