...
import cc.onion.cosyfans.base.dialog.DeleteCheckDialog;
import cc.onion.cosyfans.base.entity.SearchClass;
import cc.onion.cosyfans.base.utils.StringUtils;
import cc.onion.cosyfans.base.utils.ViewUtils;
...
public abstract class SearchBaseViewModel<T extends SearchClass> extends AndroidViewModel {
    ...
    public final ObservableBoolean isShowNodata = new ObservableBoolean(false);
    public final ObservableBoolean isShowlables = new ObservableBoolean(false);
