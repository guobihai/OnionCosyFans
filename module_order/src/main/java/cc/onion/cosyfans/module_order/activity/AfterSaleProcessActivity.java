...
import cc.onion.cosyfans.module_order.databinding.OrderAfterProcessSaleBinding;
...
import cc.onion.cosyfans.module_order.viewModel.AfterSaleProcessViewModel;
 ...
 * @Version: 1.0
 */
@Route(path = RouterPath.Order.ROUTE_ORDER_DETAIL_AFTER_SALSE_PROCESS)
public class AfterSaleProcessActivity extends BaseToolBarActivity<OrderAfterProcessSaleBinding, AfterSaleProcessViewModel> {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.order_after_process_sale);
