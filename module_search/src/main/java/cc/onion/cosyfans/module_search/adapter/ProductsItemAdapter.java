 ...
 */
public class ProductsItemAdapter extends BaseQuickAdapter<SearchResultEntity.DataBean, BaseViewHolder> {

    public ProductsItemAdapter(@Nullable List<SearchResultEntity.DataBean> data, Context activity) {
