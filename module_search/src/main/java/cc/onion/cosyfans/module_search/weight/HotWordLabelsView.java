package cc.onion.cosyfans.module_search.weight;
 ...
 * @Api
 */
public class HotWordLabelsView extends FlexboxLayout {
    ...
    public HotWordLabelsView(@NonNull Context context) {
        super(context, null);
    }

    public HotWordLabelsView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private View createLabel(Label label) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.search_view_label, this, false);
